...
from exif import Exif, readdatetaken, printalldates, exifinsert
from fisheye import fishwarppil
...
class Photo(QtCore.QObject):
    loadimage = QtCore.pyqtSignal(str, tuple, tuple)  # send text to status bar
    newlabeltext = QtCore.pyqtSignal(str)  # named Photo has new label text
...
class Canvas(QtWidgets.QLabel):
    cropboxactivated = QtCore.pyqtSignal()  # send text to status bar
...
class Worker(QtCore.QObject):
    imagesready = QtCore.pyqtSignal(str, object, object, object, tuple, int)
...
class PhotoUI(QtWidgets.QMainWindow):
    ...
    requestfullres = QtCore.pyqtSignal(str)  # request loading of full-res version of current photo
    submitfilemove = QtCore.pyqtSignal(dict)  # enqueue a file move/copy job
...
#            printalldates(file)   #### uncomment to print the various exif date information
    ...
    @QtCore.pyqtSlot(str, object, object, object, tuple, int)
...
#imfolder = r"C:\Users\ng110\Pictures\JenniYears\2016-09-Peaks, Southport"
imfolder = r"C:\Users\ng110\Pictures\JenniYears\2017-05-Dover"
imfolder = r"C:\Users\ng110\Pictures\PhotoNotes\XX Refurb notes"

#imfolder=r"P:\ST\Aykroyd NG1 C61187\Measurement\photos intray"
imfolder=r"C:\Users\neil.griffin\Documents\Dropbox\photonotes"
# imfolder=r"C:\Users\neil.griffin\Desktop\tempphotos"
imfolder=r"C:\Users\neil.griffin\Documents\Dropbox\scrapbook\Pictures\best photos, desktops"
#imfolder=r"C:\Users\neil.griffin\Desktop\ARHphotostemp"
imfolder = r"C:\Users\neil.griffin\Documents\BACKUPS TO SORT - WORK\workphotonotes"
imfolder = r"C:\Users\ng110\Pictures\JenniYears\2018-07-Liverpool"
imfolder = r"C:\Users\ng110\Pictures\JenniYears\2013-07 Aldeburgh (done)"
imfolder = r"C:\Users\ng110\Pictures\JenniYears\2018-12 Kent\ppout"
imfolder = r"C:\Users\ng110\Pictures\JenniYears\2015-\2019-06 Lincolnshire"
imfolder = r"C:\Users\ng110\Pictures\JenniYears\2015-\2017-0809-Southport,Carlisle"
imfolder = r"C:\Users\ng110\Documents\Dropbox\Neil and Jenni shared\j mugshot"
imfolder = r"C:\Users\ng110\Pictures\JenniYears\2015-\2019-0809 Cornwall,Wiltshire done ex pano"
imfolder = r"P:\LS\Overture\Virtuoso EJS C61337\3.  Design Input (S)\SB.  Client Briefing Documents\190124 nuno embryoscope images for pronucleii"
imfolder = r"C:\Users\neil.griffin\Documents\Python\Projects\TopolinoTest\PatternImages"
imfolder = r"C:\Users\neil.griffin\TTPGroup\Topolino - Documents\V2 DLP & static projector wand testing\Beamsplitter imaging tests"
...
if __name__ == '__main__':
    ...
    ui = PhotoUI(imfolder, canvassize=canvassize)   # -ve processes means threads
    sys.exit(app.exec_())
...
# exif date updates
# fix so that thumbnails get properly removed
# refactor refreshcanvas into worker with callback. deepcopy current photo object
# timer to activate refreshwaiting
...
# fix exit when directory not found
# reduce lag  ... Photo() instantiated in blocking loop??- occurs before window appears
# adjust canvassize to aspect ratio
# add options for: facebook, panorama(numbered)
# settings based on system memory available, #cores, etc
# upload to smugmug

# save and reload status
# # background load full res current image (store a recent few in memory) to allow zoom in
# # zooming view: use QGraphicView, QGraphicsScene
